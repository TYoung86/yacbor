...
function jsonNewEncodedObject() {
  jsonNewObject();
  jsonEncode();
}
expose(jsonNewEncodedObject);

encodeSuite
  .add("yacbor", yacborEncode, { setup: jsonNewObject })
  .add("native json", jsonEncode, { setup: jsonNewObject })
...
decodeSuite
  ...
  .add("native json", jsonDecode, { setup: jsonNewEncodedObject })
  .on('start', function(event) {
